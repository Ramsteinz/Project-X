...
local UPDATE_NAME = "KhaZix"
local UPDATE_HOST = "raw.github.com"
local UPDATE_PATH = "/Ramsteinz/Project-X/blob/master/KhaZix.lua" .. "?rand=" .. math.random(1, 10000)
...
function AfterDownload()
  ...
  if DOWNLOAD_COUNT == 0 then
    ...
    print("<b><font color=\"#6699FF\">KhaZix</font></b> <font color=\"#FFFFFF\">Required libraries downloaded successfully, please reload (double F9).</font>")
  end
end
...
function OnLoad()
  ...
  ts = TargetSelector(Target_LESS_CAST_PRIORITY, 1000, DAMAGE_PHYSIC, true)
  ts.name = "Kha'Zix"
