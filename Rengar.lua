...
local UPDATE_NAME = "Rengar"
local UPDATE_HOST = "raw.github.com"
local UPDATE_PATH = "/Ramsteinz/Project-X/master/Rengar.lua" .. "?rand=" .. math.random(1, 10000)
...
function AfterDownload()
  ...
  if DOWNLOAD_COUNT == 0 then
    ...
    print("<b><font color=\"#6699FF\">Rengar</font></b> <font color=\"#FFFFFF\">Required libraries downloaded successfully, please reload (double F9).</font>")
  end
end
