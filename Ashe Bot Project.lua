...
local UPDATE_PATH = "/Ramsteinz/Project-X/master/Ashe%20Bot%20Project.lua" .. "?rand=" .. math.random(1, 10000)
...
function AfterDownload()
  ...
  if DOWNLOAD_COUNT == 0 then
    ...
    print("<b><font color=\"#6699FF\">Ashe Bot Project</font></b> <font color=\"#FFFFFF\">Required libraries downloaded successfully, please reload (double F9).</font>")
  end
end
